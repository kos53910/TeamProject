         ...
         if(listBu != null){
           ...
           %>        
             $(".but").append("<tr><td><%= svoBu.getGpsubject() %></td>"
                    ...
                    + "<td><%= svoBu.getGpstart().substring(0,11) %></td>"
                    + "<td><%= svoBu.getGpend().substring(0,11) %></td></tr>");
          <%        
               }
         }
          %>
      ...
      <div class="realcontainer">
         ...
         <div class="container main" id="rightcon">
            ...
            <div style="display: flex; height: 65%;">
               <div class="calendar"
                  style="height: auto; width: 20%; margin: 0 10px;">
               ...
               <div class="notice" style="height: auto; width: 35%;">
                  <table id="noticet">
                     <tr>
                        <td colspan="2" style="text-align: center">공지사항
                        <a id="noti_click" style="text-align: right; cursor:pointer;">+</a></td>
                  ...
                  <table id="projectt">
                     <tr>
                        <td colspan="2" style="text-align: center">프로젝트</td>
                     </tr>
                     <tr>
                        <td>프로젝트명</td>
                        <td>시작일자</td>
